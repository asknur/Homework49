...
VALUES ('Асан', 'Токтосунов', 25, 'asan@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0500123456', 'avatar1.png', 'admin', true, (SELECT id FROM roles WHERE role_name = 'ADMIN')),
       ('Улан', 'Маматов', 30, 'ulan@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0500234567', 'avatar2.png', 'employer', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Алишер', 'Борбиев', 30, 'alisher@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0500123456', 'avatar2.png', 'employer', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Айгерим', 'Токтошева', 25, 'aigerim@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0700765432', 'avatar3.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Нурлан', 'Жунусов', 28, 'nurlan@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0550345678', 'avatar4.png', 'employer', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Динара', 'Султанова', 32, 'dinara@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0770987654', 'avatar5.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Азиз', 'Асанов', 27, 'aziz@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0700234567', 'avatar6.png', 'employer', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Айдана', 'Бекова', 24, 'aidana@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0550654321', 'avatar7.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Бек', 'Сатаров', 29, 'bek@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0500765432', 'avatar8.png', 'employer', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Жанна', 'Мырзаханова', 31, 'zhanna@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0770345678', 'avatar9.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Тилек', 'Сатыбалдиев', 26, 'tilek@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0700987654', 'avatar10.png', 'employer', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Гульнур', 'Абдыкадырова', 23, 'gulnur@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0550123456', 'avatar11.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Данияр', 'Жолдошов', 35, 'daniyar@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0500987123', 'avatar12.png', 'employer', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Сания', 'Токтомамбетова', 28, 'sania@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0700543210', 'avatar13.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Марат', 'Кайратов', 31, 'marar@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0550765432', 'avatar14.png', 'employer', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ('Ляззат', 'Кожомкулова', 29, 'lazzat29@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0770345670', 'avatar15.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ...
       ('Нургуль', 'Бекматова', 25, 'nurgul@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0550654320', 'avatar17.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ...
       ('Мадина', 'Жусупова', 30, 'madina@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0770345671', 'avatar19.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ...
       ('Салтанат', 'Карабаева', 26, 'saltanat@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0550123457', 'avatar21.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ...
       ('Айсулуу', 'Тилекова', 29, 'aisulu@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0700543211', 'avatar23.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ...
       ('Лейла', 'Алимова', 27, 'leila@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0770345672', 'avatar25.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ...
       ('Гульмира', 'Садырбаева', 24, 'gulmira@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0550654322', 'avatar27.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
       ...
       ('Айпери', 'Бектемирова', 26, 'aiperi@ex.com', '$2a$12$WB2YUbFcCN0tm44SBcKUjua9yiFBsfB3vW02IjuwzY7HGtlQIKzy2', '0770345673', 'avatar29.png', 'employee', true, (SELECT id FROM roles WHERE role_name = 'USER')),
